...
export default function ResearchTimeline() {
  ...
  // Defined inside component so they're fresh each render and never stale
  const up = <FontAwesomeIcon icon={faAngleUp} style={{ color: "var(--accent-magenta-soft)" }} />;
  const down = <FontAwesomeIcon icon={faAngleDown} style={{ color: "var(--accent-sage)" }} />;
  const neutral = <FontAwesomeIcon icon={faAnglesRight} />;
  const star = <FontAwesomeIcon icon={faAnglesDown} style={{ color: "var(--accent-sage)" }} />;

  // Moved inside component so JSX elements (up/down/neutral/star) are in scope
